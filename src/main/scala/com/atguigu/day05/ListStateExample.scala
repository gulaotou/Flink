...
import com.atguigu.day03.{SensorReading, SensorSource}
...
object ListStateExample {
  def main(args: Array[String]): Unit = {
    ...
    // windows: file:\\ + 绝对路径
    env.setStateBackend(new FsStateBackend("file:///D:\\MyWork\\idea\\work01\\mavenwork\\Flink\\src\\main\\resources\\test"))
